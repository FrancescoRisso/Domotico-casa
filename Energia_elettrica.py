...
values = [
    {
        "name": "General",
        "value": None,
        "baselink": f"{config['Datalogger']['ip']}/grap_0100"
    },
    {
        "name": "House",
        "value": None,
        "baselink": f"{config['Datalogger']['ip']}/grap_0101"
    },
    {
        "name": "Downstairs",
        "value": None,
        "baselink": f"{config['Datalogger']['ip']}/grap_0102"
    },
    {
        "name": "Warming",
        "value": None,
        "baselink": f"{config['Datalogger']['ip']}/grap_0103"
    },
    {
        "name": "Hot_water",
        "value": None,
        "baselink": f"{config['Datalogger']['ip']}/grap_0104"
    },
    {
        "name": "Solar_panel",
        "value": None,
...
while lastexe <= now:
    ...
    insert(values, writer, lastexe, "CONSUMPTIONS")
